            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-tachometer-alt"></i> <span data-key="t-dashboards">Tambahkan Data</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/dashboard/dinas" class="nav-link" data-key="t-analytics"> Data Dinas </a>
                            </li>
                            <li class="nav-item">
                                <a href="/dashboard/admin" class="nav-link" data-key="t-crm"> Data Admin </a>
                            </li>
                            <li class="nav-item">
                                <a href="/user" class="nav-link" data-key="t-crm"> Data Peserta Magang </a>
                            </li>
                        </ul>
                    </div>
